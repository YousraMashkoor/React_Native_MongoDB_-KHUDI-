    ...
    render(){
        return(
            ...
            <KeyboardAvoidingView behavior="padding">
                ...
                <Image
                    style={{width: width, height: height/2, justifyContent:'center',resizeMode: 'contain'}}
                    source={require('./../../assets/gifs/become-seller2.gif')} />
                <TapGestureHandler onHandlerStateChange={() => this.props.navigation.navigate('sellerForm')}>
                    <MaterialIcons name="play-circle-filled" size={130} color="#38DFEB" style={{justifyContent:'center', position:'absolute',marginTop:height/2.9,marginLeft:width/5.3}} />
                </TapGestureHandler>
                </View>
